...
public abstract class IntentBuilder {
    ...
    public JInvocation getSuperPutExtraInvocation(TypeMirror elementType, JVar extraParam, JFieldVar extraKeyField) {
        ...
        if (elementType.getKind() == TypeKind.DECLARED) {
            ...
            if (typeUtils.isSubtype(elementType, parcelableType)) {
                ...
                extraParameterArg = environment.getJClass(CanonicalNameConstants.PARCELS_UTILITY_CLASS).staticInvoke("wrap")
                        .arg(extraParameterArg);
            } else {
    ...
    public static class IntentExtra {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(type, that.type) && Objects.equals(parameterName, that.parameterName)
