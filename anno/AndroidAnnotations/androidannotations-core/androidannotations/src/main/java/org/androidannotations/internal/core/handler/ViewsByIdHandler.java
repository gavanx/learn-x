...
public class ViewsByIdHandler extends BaseAnnotationHandler<EComponentWithViewSupportHolder> implements
    ...
    private void addViewToListIfNotNull(IJExpression elementRef, AbstractJClass viewClass, JFieldRef idRef,
