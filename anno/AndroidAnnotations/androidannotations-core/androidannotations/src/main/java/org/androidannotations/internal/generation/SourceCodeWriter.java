...
public class SourceCodeWriter extends AbstractCodeWriter {
    ...
    public OutputStream openBinary(JPackage pkg, String fileName) throws IOException {
        ...
        try {
            ...
            /*
             * This exception is expected, when some files are created twice. We cannot delete existing files, unless using a
             * dirty hack. Files a created twice when the same file is created from different annotation rounds. Happens when
             * renaming classes, and for Background executor. It also probably means I didn't fully understand how annotation
             * processing works. If anyone can point me out...
             */
