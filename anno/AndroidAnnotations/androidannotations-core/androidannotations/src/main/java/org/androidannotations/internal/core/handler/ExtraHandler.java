...
public class ExtraHandler extends BaseAnnotationHandler<EActivityHolder> implements MethodInjectionHandler<EActivityHolder>,
    ...
    public void validate(Element element, ElementValidation validation) {
        /*
         * TODO since we override setIntent(), we should check that the setIntent() method can be overridden
         */
    ...
    public void assignValue(JBlock targetBlock, IJAssignmentTarget fieldRef, EActivityHolder holder, Element element, Element param) {
        ...
        IJExpression restoreMethodCall = bundleHelper.getExpressionToRestoreFromIntentOrBundle(elementClass, intent, extras,
                extraKeyStaticField, injectExtrasMethod);
