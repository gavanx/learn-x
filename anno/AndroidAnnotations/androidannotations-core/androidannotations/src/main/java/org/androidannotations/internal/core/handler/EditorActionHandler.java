...
public class EditorActionHandler extends AbstractViewListenerHandler {
    ...
    @Override
    protected void processParameters(EComponentWithViewSupportHolder holder, JMethod listenerMethod, JInvocation call,
        ...
        for (VariableElement param : userParameters) {
            ...
            } else if (paramClassQualifiedName.equals(CanonicalNameConstants.INTEGER)
