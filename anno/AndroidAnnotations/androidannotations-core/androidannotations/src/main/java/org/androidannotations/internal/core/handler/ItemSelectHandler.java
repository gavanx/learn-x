...
public class ItemSelectHandler extends AbstractViewListenerHandler {
    ...
    @Override
    protected void processParameters(EComponentWithViewSupportHolder holder, JMethod listenerMethod, JInvocation itemSelectedCall,
        ...
        if (hasItemParameter) {
            ...
            if (secondParameterIsInt) {
                ...
                itemSelectedCall.arg(JExpr.cast(getJClass(secondParameterQualifiedName), invoke(onItemClickParentParam, "getAdapter")
