...
public abstract class ExtraParameterHandler extends BaseAnnotationHandler<GeneratedClassHolder> {
    ...
    public ExtraParameterHandler(Class<? extends Annotation> targetClass, Class<? extends Annotation> methodAnnotationClass,
    ...
    public IJExpression getExtraValue(VariableElement parameter, JVar intent, JVar extras, JBlock block, JMethod annotatedMethod,
    ...
    public IJExpression getExtraValue(VariableElement parameter, JVar intent, JVar extras, JBlock block, JMethod annotatedMethod,
        ...
        IJExpression restoreMethodCall = bundleHelper.getExpressionToRestoreFromIntentOrBundle(parameterClass, intent, extras,
                getStaticExtraField(generatedClass, extraKey), annotatedMethod);
