...
public class CorePlugin extends AndroidAnnotationsPlugin {
    ...
    public List<AnnotationHandler<?>> getHandlers(AndroidAnnotationsEnvironment androidAnnotationEnv) {
        ...
        /*
         * WakeLockHandler must be after TraceHandler but before UiThreadHandler and BackgroundHandler
         */
        annotationHandlers.add(new WakeLockHandler(androidAnnotationEnv));

        /*
         * UIThreadHandler and BackgroundHandler must be after TraceHandler and IgnoreWhen
         */
        ...
        /*
         * SupposeUiThreadHandler and SupposeBackgroundHandler must be after all handlers that modifies generated method body
         */
