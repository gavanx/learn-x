...
public class ModelValidator {
    ...
    public AnnotationElements validate(AnnotationElements extractedModel, AnnotationElementsHolder validatingHolder)
        ...
        /*
         * We currently do not validate the elements on the ancestors, assuming they've already been validated. This also means
         * some checks such as unique ids might not be check all situations.
         */
