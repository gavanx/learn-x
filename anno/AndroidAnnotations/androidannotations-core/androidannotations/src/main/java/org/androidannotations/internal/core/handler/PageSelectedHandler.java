...
public class PageSelectedHandler extends AbstractPageChangeHandler {
    public PageSelectedHandler(AndroidAnnotationsEnvironment environment) {
    ...
    public void process(Element element, EComponentWithViewSupportHolder holder) throws Exception {
        ...
        for (JFieldRef idRef : idsRefs) {
            PageChangeHolder pageChangeHolder = holder.getPageChangeHolder(idRef, viewPagerParameterType,
                    hasAddOnPageChangeListenerMethod());
