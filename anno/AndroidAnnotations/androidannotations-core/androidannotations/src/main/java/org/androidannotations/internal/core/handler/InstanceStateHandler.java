...
public class InstanceStateHandler extends BaseAnnotationHandler<HasInstanceState> {
    ...
    public void process(Element element, HasInstanceState holder) {
        ...
        IJExpression restoreMethodCall = bundleHelper.getExpressionToRestoreFromBundle(elementClass, restoreStateBundleParam,
                JExpr.lit(fieldName), restoreStateMethod);
