...
public class KeyEventCallbackMethodsDelegate<T extends EComponentWithViewSupportHolder & HasKeyEventCallbackMethods> extends
        GeneratedClassHolderDelegate<T> {
