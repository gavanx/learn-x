...
public abstract class Binding<T> implements Provider<T>, MembersInjector<T> {
    ...
    /**
     * Populates {@code getBindings} and {@code injectMembersBindings} with the bindings used by this binding to satisfy
     * {@link #get} and {@link #injectMembers} calls, respectively.
     * 
     * @param getBindings the bindings required by this binding's {@code get} method. Although {@code get} usually calls
     *            into {@code injectMembers}, this <i>does not</i> contain the injectMembers bindings.
     * @param injectMembersBindings the bindings required by this binding's {@code injectMembers} method.
     */
