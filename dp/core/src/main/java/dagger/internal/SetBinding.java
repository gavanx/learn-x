...
/**
 * A {@code Binding<T>} which contains contributors (other bindings marked with {@code @Provides} {@code @OneOf}), to
 * which it delegates provision requests on an as-needed basis.
 */
public final class SetBinding<T> extends Binding<Set<T>> {
    ...
    /**
     * A {@link SetBinding} with whose contributing bindings this set-binding provides a union view.
     */
    ...
    /**
     * Creates a new {@code SetBinding} with the given "provides" key, and the requiredBy object for traceability.
     */
    ...
    /**
     * Creates a new {@code SetBinding} with all of the contributing bindings of the provided original
     * {@code SetBinding}.
     */
    ...
    @SuppressWarnings("unchecked")
    // Only Binding<T> and Set<T> are added to contributors.
    @Override
    public Set<T> get() {
