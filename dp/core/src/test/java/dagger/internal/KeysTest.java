...
public final class KeysTest {
    ...
    public void lonePrimitiveGetsBoxed() throws NoSuchFieldException {
        assertThat(fieldKey("primitive")).isEqualTo("java.lang.Integer");
    }
    ...
    public void parameterizedTypes() throws NoSuchFieldException {
        assertThat(fieldKey("mapStringListInteger")).isEqualTo("java.util.Map<java.lang.String, java.util.List<java.lang.Integer>>");
    }
    ...
    public void parameterizedTypeOfPrimitiveArray() throws NoSuchFieldException {
        assertThat(fieldKey("mapStringArrayInt")).isEqualTo("java.util.Map<java.lang.String, int[]>");
    }
    ...
    public void annotatedType() throws NoSuchFieldException {
        assertThat(fieldKey("annotatedType")).isEqualTo("@javax.inject.Named(value=foo)/java.lang.String");
    }
    ...
    public void testGetClassName() throws NoSuchFieldException {
        assertThat(Keys.getClassName(fieldKey("className"))).isEqualTo("java.lang.String");
    }

    @Named("foo")
    String classNameWithAnnotation;

    @Test
    public void testGetClassNameWithoutAnnotation() throws NoSuchFieldException {
        assertThat(Keys.getClassName(fieldKey("classNameWithAnnotation"))).isEqualTo("java.lang.String");
    }
    ...
    public void testGetDelegateKey() throws NoSuchFieldException {
        assertThat(Keys.getBuiltInBindingsKey(fieldKey("providerOfType"))).isEqualTo(fieldKey("providedType"));
    }

    @Named("/@")
    Provider<String> providerOfTypeAnnotated;
    @Named("/@")
    String providedTypeAnnotated;

    @Test
    public void testGetDelegateKeyWithAnnotation() throws NoSuchFieldException {
        assertThat(Keys.getBuiltInBindingsKey(fieldKey("providerOfTypeAnnotated"))).isEqualTo(fieldKey("providedTypeAnnotated"));
    }

    @Named("/@")
    MembersInjector<String> membersInjectorOfType;
    @Named("/@")
    String injectedType;

    @Test
    public void testGetDelegateKeyWithMembersInjector() throws NoSuchFieldException {
        assertThat(Keys.getBuiltInBindingsKey(fieldKey("membersInjectorOfType"))).isEqualTo("members/java.lang.String");
    }

    @Named("/@")
    Lazy<String> lazyAnnotatedString;
    @Named("/@")
    String eagerAnnotatedString;

    @Test
    public void testAnnotatedGetLazyKey() throws NoSuchFieldException {
        assertThat(Keys.getLazyKey(fieldKey("lazyAnnotatedString"))).isEqualTo(fieldKey("eagerAnnotatedString"));
    }
    ...
    public void testGetElementKey_NoQualifier() throws NoSuchMethodException {
        ...
        assertThat(Keys.getSetKey(method.getGenericReturnType(), method.getAnnotations(), method)).isEqualTo("java.util.Set<java.lang.String>");
    }

    @Named("foo")
    @Provides(type = SET)
    String qualifiedElementProvides() {
        return "foo";
    }
    ...
    public void testGetElementKey_WithQualifier() throws NoSuchMethodException {
        ...
        assertThat(Keys.getSetKey(method.getGenericReturnType(), method.getAnnotations(), method)).isEqualTo("@javax.inject.Named(value=foo)/java.util.Set<java.lang.String>");
    }
