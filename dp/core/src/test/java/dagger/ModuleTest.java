...
public final class ModuleTest {
    ...
    @Module(includes = TestModuleA.class, injects = B.class)
    ...
    public void provideProviderFails() {
        ...
        try {
            ...
            assertThat(e.getMessage()) //
                .startsWith("@Provides method must not return Provider directly: ").endsWith("ProvidesProviderModule.provideObject");
        }
    }
    ...
    public void provideRawProviderFails() {
        ...
        try {
            ...
            assertThat(e.getMessage()) //
                .startsWith("@Provides method must not return Provider directly: ").endsWith("ProvidesRawProviderModule.provideObject");
        }
    }
    ...
    public void provideLazyFails() {
        ...
        try {
            ...
            assertThat(e.getMessage()) //
                .startsWith("@Provides method must not return Lazy directly: ").endsWith("ProvidesLazyModule.provideObject");
        }
    }
    ...
    public void provideRawLazyFails() {
        ...
        try {
            ...
            assertThat(e.getMessage()) //
                .startsWith("@Provides method must not return Lazy directly: ").endsWith("ProvidesRawLazyModule.provideObject");
        }
    }
}
