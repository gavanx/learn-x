...
public final class ProviderMethodsModule implements Module {
    ...
    private <T> ProviderMethod<T> createProviderMethod(Binder binder, Method method, Annotation annotation) {
        ...
        return ProviderMethod.create(key, method, delegate, ImmutableSet.copyOf(dependencies), parameterProviders, scopeAnnotation, skipFastClassGeneration, annotation);
    }
    ...
    public boolean equals(Object o) {
        return o instanceof ProviderMethodsModule && ((ProviderMethodsModule) o).delegate == delegate && ((ProviderMethodsModule) o).scanner == scanner;
    }
