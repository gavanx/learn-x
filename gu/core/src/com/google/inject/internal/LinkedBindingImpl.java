...
public final class LinkedBindingImpl<T> extends BindingImpl<T> implements LinkedKeyBinding<T>, HasDependencies {
    ...
    public String toString() {
        return Objects.toStringHelper(LinkedKeyBinding.class).add("key", getKey()).add("source", getSource()).add("scope", getScoping()).add("target", targetKey).toString();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof LinkedBindingImpl) {
            ...
            return getKey().equals(o.getKey()) && getScoping().equals(o.getScoping()) && Objects.equal(targetKey, o.targetKey);
        } else {
            return false;
        }
    }
