...
final class ProviderInstanceBindingImpl<T> extends BindingImpl<T> implements ProviderInstanceBinding<T> {
    ...
    public String toString() {
        return Objects.toStringHelper(ProviderInstanceBinding.class).add("key", getKey()).add("source", getSource()).add("scope", getScoping()).add("provider", providerInstance).toString();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ProviderInstanceBindingImpl) {
            ...
            return getKey().equals(o.getKey()) && getScoping().equals(o.getScoping()) && Objects.equal(providerInstance, o.providerInstance);
        } else {
            return false;
        }
    }
