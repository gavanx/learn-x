...
final class LinkedProviderBindingImpl<T> extends BindingImpl<T> implements ProviderKeyBinding<T>, HasDependencies, DelayedInitialize {
    ...
    LinkedProviderBindingImpl(Object source, Key<T> key, Scoping scoping, Key<? extends javax.inject.Provider<? extends T>> providerKey) {
    ...
    public String toString() {
        return Objects.toStringHelper(ProviderKeyBinding.class).add("key", getKey()).add("source", getSource()).add("scope", getScoping()).add("provider", providerKey).toString();
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof LinkedProviderBindingImpl) {
            ...
            return getKey().equals(o.getKey()) && getScoping().equals(o.getScoping()) && Objects.equal(providerKey, o.providerKey);
        } else {
            return false;
        }
    }
