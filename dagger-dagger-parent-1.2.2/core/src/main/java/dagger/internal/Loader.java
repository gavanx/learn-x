...
/**
 * Provides a point of configuration of the basic resolving functions within Dagger, namely that of Module handling,
 * injection binding creation, and static injection. A plugin must provide all resolution methods
 */
public abstract class Loader {
    ...
    /**
     * Returns a binding that uses {@code @Inject} annotations, or null if no valid binding can be found or created.
     */
    ...
    /**
     * Returns a module adapter for {@code moduleClass} or throws a {@code TypeNotPresentException} if none can be
     * found.
     */
    ...
    /**
     * Loads a class from a {@code ClassLoader}-specific cache if it's already there, or loads it from the given
     * {@code ClassLoader} and caching it for future requests. Failures to load are also cached using the Void.class
     * type. A null {@code ClassLoader} is assumed to be the system classloader.
     */
    ...
    /**
     * Instantiates a class using its default constructor and the given {@link ClassLoader}. This method does not
     * attempt to {@linkplain AccessibleObject#setAccessible set accessibility}.
     */
