...
public abstract class ModuleAdapter<T> {
    ...
    protected ModuleAdapter(Class<T> moduleClass, String[] injectableTypes, Class<?>[] staticInjections, boolean overrides, Class<?>[] includes,
            boolean complete, boolean library) {
    ...
    /**
     * Returns bindings for the {@code @Provides} methods of {@code module}. The returned bindings must be linked before
     * they can be used to inject values.
     */
    ...
    /**
     * Returns a new instance of the module class created using a no-args constructor. Only used when a
     * manually-constructed module is not supplied.
     */
