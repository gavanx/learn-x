...
public final class Linker {
    ...
    /**
     * The base {@code Linker} which will be consulted to satisfy bindings not otherwise satisfiable from this
     * {@code Linker}. The top-most {@code Linker} in a chain will have a null base linker.
     */
    ...
    /**
     * An unmodifiable map containing all of the bindings available in this linker, fully linked. This will be null if
     * the bindings are not yet fully linked. It provides both a signal of completion of the {@link #linkAll()} method,
     * as well as a place to reference the final, fully linked map of bindings.
     */
    ...
    /**
     * Adds all bindings in {@code toInstall}. The caller must call either {@link #linkAll} or {@link #requestBinding}
     * and {@link #linkRequested} before the bindings can be used. This method may only be called before
     * {@link #linkAll()}. Subsequent calls to {@link #installBindings(BindingsGroup)} will throw an
    ...
    /**
     * Links all known bindings (whether requested or installed), plus all of their transitive dependencies. This loads
     * injectable types' bindings as necessary to fill in the gaps. If this method has returned successfully at least
     * once, all further work is short-circuited.
     * 
     * @throws AssertionError if this method is not called within a synchronized block which holds this {@link Linker}
     *             as the lock object.
     */
    ...
    /**
     * Returns the map of all bindings available to this {@link Linker}, if and only if {@link #linkAll()} has
     * successfully returned at least once, otherwise it returns null;
     */
    ...
    /**
     * Links all requested bindings plus their transitive dependencies. This creates JIT bindings as necessary to fill
     * in the gaps.
     * 
     * @throws AssertionError if this method is not called within a synchronized block which holds this {@link Linker}
     *             as the lock object.
    ...
    /**
     * Don't permit bindings to be linked without a lock. Callers should lock before requesting any bindings, link the
     * requested bindings, retrieve the linked bindings, and then release the lock.
     */
    ...
    /**
     * Returns a binding for the key in {@code deferred}. The type of binding to be created depends on the key's type:
     * <ul>
     * <li>Injections of {@code Provider<Foo>}, {@code MembersInjector<Bar>}, and {@code Lazy<Blah>} will delegate to
     * the bindings of {@code Foo}, {@code Bar}, and {@code Blah} respectively.
    ...
    private Binding<?> createBinding(String key, Object requiredBy, ClassLoader classLoader, boolean mustHaveInjections) {
        ...
        Binding<?> binding = plugin.getAtInjectBinding(key, className, classLoader, mustHaveInjections);
        if (binding != null) {
            return binding;
        }
    ...
    /**
     * Returns the binding if it exists immediately. Otherwise this returns null. If the returned binding didn't exist
     * or was unlinked, it will be enqueued to be linked.
     */
     ...
     * or was unlinked, it will be enqueued to be linked.
     * 
     * @param mustHaveInjections true if the the referenced key requires either an {@code @Inject} annotation is
     *            produced by a {@code @Provides} method. This isn't necessary for Module.injects types because
     *            frameworks need to inject arbitrary classes like JUnit test cases and Android activities. It also
     *            isn't necessary for supertypes.
     */
    ...
    /**
     * Puts the mapping {@code key, value} in {@code map} if no mapping for {@code key} already exists.
     */
    ...
    private static class SingletonBinding<T> extends Binding<T> {
        ...
        // onlyInstance is either 'UNINITIALIZED' or a 'T'.
        @Override
        public T get() {
    ...
    public interface ErrorHandler {
        ...
        /**
         * Fail if any errors have been enqueued. Implementations may throw exceptions or report the errors through
         * another channel. Callers are responsible for clearing enqueued errors.
         * 
