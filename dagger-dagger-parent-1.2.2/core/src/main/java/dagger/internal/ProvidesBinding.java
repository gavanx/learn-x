...
public abstract class ProvidesBinding<T> extends Binding<T> {
    ...
    /**
     * Creates a new {@code ProvidesBinding} with the given "provides" key, a flag as to whether this binding should be
     * scoped, and the requiredBy object for traceability.
     */
    ...
    /**
     * A provides binding is responsible for implementing storage of the module instance, and delegation to that module
     * instance's method.
     */
    @Override
